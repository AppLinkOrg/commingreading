...
export class BookApi{
    ...
    booktypelist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'book/booktypelist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    deleteread(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'book/deleteread',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    rdlist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'book/rdlist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    readinfo(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'book/readinfo',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    recordagain(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'book/recordagain',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    keywordlist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'book/keywordlist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
