...
export class TalkApi{
    ...
    addlisten(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'talk/addlisten',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    addreadcount(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'talk/addreadcount',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
